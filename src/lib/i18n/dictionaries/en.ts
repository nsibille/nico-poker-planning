...
export const en = {
  ...
  heroLoop: {
    ...
    stories: [
      ...
      'Deploy to prod on a Friday at 5pm',
      'Rename the variable data2_final_OK',
      'Add a Cancel button that actually cancels',
      'Delete the TODO from 2019',
      'Figure out why it works locally',
      'Repaint the bikeshed in Scrumbler blue',
      'Make the loader feel more premium',
      'Estimate the tech debt (recursive)',
      'Rewrite the bash script in Rust',
      'Document the API nobody uses',
      'Turn off the forgotten feature flag',
      'Update dependencies (npm audit: 4127)',
      'Convince the PO that no is a feature',
      'Add a dark mode to the dark mode',
      'Trim 3 MB of fonts from the bundle',
      'Fix the fix of the hotfix',
      'Center two divs (epic)',
      'Translate the app into Klingon',
      'Hide the easter egg before the demo',
      'Migrate from Jira to another Jira',
      'Optimize a loop that runs once a year',
      'Add telemetry to measure the telemetry',
      '15-min standup, the 45-min edition',
      'Replace the regex with another regex',
      'Make the form accessible to humans',
      'Unplug the server under Jean’s desk',
      'Reconcile the design with reality',
      'Push test coverage to 100% (mock everything)',
      'Prep the Q3 roadmap (it’s already Q3)',
    ],
  },
  problem: {
