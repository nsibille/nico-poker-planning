...
export const fr = {
  ...
  heroLoop: {
    ...
    stories: [
      'Refactor du module d’authentification',
      'Déployer en prod un vendredi à 17h',
      'Renommer la variable data2_final_OK',
      'Ajouter un bouton Annuler qui annule vraiment',
      'Supprimer le TODO de 2019',
      'Comprendre pourquoi ça marche en local',
      'Repeindre le bikeshed en bleu Scrumbler',
      'Rendre le loader plus premium',
      'Estimer la dette technique (récursif)',
      'Réécrire le script bash en Rust',
      'Documenter l’API que personne n’utilise',
      'Désactiver la feature flag oubliée',
      'Mettre à jour les dépendances (npm audit: 4127)',
      'Convaincre le PO que non est une feature',
      'Ajouter un dark mode au dark mode',
      'Retirer 3 Mo de polices du bundle',
      'Fix du fix du hotfix',
      'Centrer deux divs (epic)',
      'Traduire l’app en klingon',
      'Cacher l’easter egg avant la démo',
      'Migrer de Jira vers un autre Jira',
      'Optimiser une boucle lancée une fois par an',
      'Ajouter de la télémétrie pour mesurer la télémétrie',
      'Standup de 15 min, édition 45 min',
      'Remplacer la regex par une autre regex',
      'Rendre le formulaire accessible aux humains',
      'Débrancher le serveur sous le bureau de Jean',
      'Réconcilier le design avec la réalité',
      'Monter la couverture de tests à 100% (tout mocker)',
      'Préparer la roadmap Q3 (on est en Q3)',
    ],
  },
  problem: {
